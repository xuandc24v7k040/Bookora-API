...
async function seedCrossBranchFixture(prisma: PrismaService): Promise<Fixture> {
  ...
  await prisma.order.create({
    data: {
      ...
      idempotencyKey: 'legacy-cross-branch-order',
      userId: IDS.customer,
      branchId: IDS.hauGiang,
      ...
      shippingFee: 0,
      totalAmount: 100_000,
      deliveryAddressSource: DeliveryAddressSource.CURRENT_LOCATION,
      receiverName: 'Customer',
      receiverPhone: '0900000000',
      shippingAddress: 'Hậu Giang',
      shippingAddressLine: 'Hậu Giang',
      shippingProvinceName: 'Hậu Giang',
      shippingDistrictName: 'Hậu Giang',
      shippingWardName: 'Hậu Giang',
      shippingGhnProvinceId: 1,
      shippingGhnDistrictId: 1,
      shippingGhnWardCode: '1',
      branchNameSnapshot: 'Hậu Giang',
      branchAddressSnapshot: 'Hậu Giang',
      shippingProviderSnapshot: 'GHN',
      shippingServiceId: 1,
      shippingServiceTypeId: 2,
      shippingServiceName: 'GHN Tiêu chuẩn',
      shippingFeeBreakdownSnapshot: {},
      shippingQuoteReference: 'legacy-cross-branch-fixture',
    },
  });
